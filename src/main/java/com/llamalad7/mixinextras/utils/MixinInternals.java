...
public class MixinInternals {
    ...
    private static final com.llamalad7.mixinextras.utils.InternalMethod<IMixinInfo, ?> MIXIN_INFO_GET_STATE
            = com.llamalad7.mixinextras.utils.InternalMethod.of("org.spongepowered.asm.mixin.transformer.MixinInfo", "getState");
    ...
    private static final com.llamalad7.mixinextras.utils.InternalMethod<?, Void> CLASS_INFO_FROM_CLASS_NODE
            = com.llamalad7.mixinextras.utils.InternalMethod.of(ClassInfo.class, "fromClassNode", ClassNode.class);
