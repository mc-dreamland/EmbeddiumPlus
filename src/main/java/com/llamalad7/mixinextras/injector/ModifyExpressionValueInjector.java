...
public class ModifyExpressionValueInjector extends Injector {
    ...
    protected void inject(Target target, InjectionNode node) {
        ...
        com.llamalad7.mixinextras.injector.StackExtension stack = new com.llamalad7.mixinextras.injector.StackExtension(target);
    ...
    private void injectValueModifier(Target target, AbstractInsnNode valueNode, Type valueType, boolean isDupedFactoryRedirect, boolean shouldPop, com.llamalad7.mixinextras.injector.StackExtension stack) {
