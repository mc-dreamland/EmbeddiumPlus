...
class SugarInjector {
    ...
    private final List<com.llamalad7.mixinextras.sugar.impl.SugarParameter> strippedSugars = new ArrayList<>();
    ...
    static HandlerInfo getHandlerInfo(IMixinInfo mixin, MethodNode handler, List<AnnotationNode> sugarAnnotations, List<Type> generics) {
        ...
        for (com.llamalad7.mixinextras.sugar.impl.SugarParameter sugar : findSugars(handler, sugarAnnotations, generics)) {
    ...
    private static void wrapInjectorAnnotation(IMixinInfo mixin, MethodNode method) {
        ...
        AnnotationNode wrapped = new AnnotationNode(Type.getDescriptor(com.llamalad7.mixinextras.sugar.impl.SugarWrapper.class));
    ...
    private void makeApplicators() {
        for (com.llamalad7.mixinextras.sugar.impl.SugarParameter sugar : strippedSugars) {
    ...
    void reSugarHandler() {
        ...
        for (com.llamalad7.mixinextras.sugar.impl.SugarParameter parameter : strippedSugars) {
    ...
    private static List<com.llamalad7.mixinextras.sugar.impl.SugarParameter> findSugars(MethodNode handler, List<AnnotationNode> sugarAnnotations, List<Type> generics) {
        List<com.llamalad7.mixinextras.sugar.impl.SugarParameter> result = new ArrayList<>();
