...
abstract class SugarApplicator {
    ...
    static {
        List<Pair<Class<? extends Annotation>, Class<? extends SugarApplicator>>> sugars = Arrays.asList(
                Pair.of(Local.class, com.llamalad7.mixinextras.sugar.impl.LocalSugarApplicator.class),
                Pair.of(Share.class, com.llamalad7.mixinextras.sugar.impl.ShareSugarApplicator.class)
        );
    ...
    SugarApplicator(InjectionInfo info, com.llamalad7.mixinextras.sugar.impl.SugarParameter parameter) {
    ...
    static SugarApplicator create(InjectionInfo info, com.llamalad7.mixinextras.sugar.impl.SugarParameter parameter) {
        try {
